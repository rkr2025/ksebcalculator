...
import { buildBillExplanation, buildTodCalculationExplanation, buildWheelingCalculationExplanation } from './render-explanation.js';
import { buildPrintInputsSummary } from './render-print-summary.js';
...
// calculated yet).
export const APP_VERSION_LABEL = 'Version 3.0.129: Last updated: 07-August-2026';
...
export function renderBillResults(bill, readingPairs) {
    ...
    const wheelingBreakdown = renderWheelingResult(bill.wheelingResult) + buildWheelingCalculationExplanation(bill);
    const billExplanation = buildBillExplanation(bill);
    const printInputsSummary = buildPrintInputsSummary(bill, readingPairs);
